...
export default function ProductPopup({popupDisplay,imgURL = "https://images.unsplash.com/photo-1638456266087-09b1d160748b?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" , title = "Title", description , price}) {
        ...
        <div className="product-popup-container">
          <div className="product-popup-image">
            <div className="wishlist-button">
              <FavoriteTwoToneIcon style={{color:Wishlisted ? "red" : "white"}} onClick={() => setWishlisted(!Wishlisted)}/>
            </div>
            <img src={imgURL}></img>
          </div>
